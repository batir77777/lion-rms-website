    ...
    <section className="bg-ink-50">
      <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6">
        <div className="grid items-center gap-10 sm:grid-cols-[auto_1fr] sm:gap-12">
          <Reveal>
            <div className="mx-auto h-40 w-40 overflow-hidden rounded-2xl bg-brand-700 shadow-lg">
              {imgFailed ? (
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {ASSESSOR.credentials.map((c) => (
                  <span key={c} className="rounded-full bg-white px-3 py-1 text-xs font-semibold text-brand-800 ring-1 ring-brand-100">
                    {c}
                  </span>
                ))}
              </div>
